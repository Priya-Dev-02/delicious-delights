...
class ContDetailsScreen extends StatefulWidget {
  ...
  @override
  State<ContDetailsScreen> createState() => _ContDetailsScreenState();
}

class _ContDetailsScreenState extends State<ContDetailsScreen> {
